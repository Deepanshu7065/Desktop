...
export const GetALlShopOrderApi = ({
    ...
    return useQuery({
        queryKey: ["order", page, limit, searchQuery],
        queryFn: getMyOrder,
    })
}
...
export const GetRepairDataPrice = () => {
    const getRepair = async () => {
        try {
            const response = await axios.get(`${baseUrl}/price/get`)
            return response.data as RepairPriceTypes[]
        } catch (error) {
            console.log(error)
        }
    }
...
export const GetRepairDataPriceById = ({ id }: { id: string }) => {
    const getRepair = async () => {
        try {
            const response = await axios.get(`${baseUrl}/price/get/${id}`)
            return response.data as RepairPriceTypes
        } catch (error) {
            console.log(error)
        }
